...
const About = () => {
  return (
    ...
    >
      <div className="w-11/12 mt-28 lg:mt-0 md:w-11/12 lg:w-11/12 xl:w-7/12  mx-auto  z-0">
        <div className="flex w-full px-4 py-2 bg-white rounded-xl shadow-xl my-2">
          <h1 className="text-[46px] text-[#0d0e12] w-full flex justify-between items-center">
            ...
            <div className="w-3/5 md:w-3/5 lg:4/5 h-[3px]  bg-[#0d0e12] "></div>
          </h1>
        </div>
        {/*  */}
        <div className="flex shadow-xl bg-[#f6f6f8] rounded-xl">
          <div className="flex flex-col-reverse md:flex-row justify-between my-1  p-4">
            <div className="flex w-full md:w-3/5   p-4 flex-col">
            ...
            <div className="flex w-full md:w-2/5  justify-center p-4">
              <img
                src={avatar}
                alt="avatar"
                height={300}
      ...
      <div className="flex justify-around my-2 rounded-xl bg-[#0d0e12] text-white w-11/12 md:w-11/12 lg:w-11/12 xl:w-7/12 mx-auto p-4">
